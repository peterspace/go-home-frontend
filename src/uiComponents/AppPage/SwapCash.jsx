...
import StatusSubmitted from './status/StatusSubmitted';
import StatusInitialized from './status/StatusInitialized';
...
*/
  ...
  async function converterUSDTUSD() {
    let newRate = parseFloat(rateSell);
        ...
        <>
          ...
          isSettings === false ? (
            <>
              ...
              {!nextPage && !isProcessingOrder && !isSubmitted ? (
                <div
