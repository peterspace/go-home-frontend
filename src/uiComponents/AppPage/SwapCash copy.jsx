  ...
  async function getChainBalance() {
    if (isConnected) {
      ...
      if (isNaN(tokenbal)) {
        ...
        //======================={TO TOKEN BALANCE}==================================================
        if (
          tToken?.address === '0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' ||
          !tToken?.address
        ) {
...
*/
  ...
  async function fetchToPrice() {
    if (tToken?.symbol === 'USD') {
      ...
      setExchangeRate(Number(fValue) * Number(tToken?.rate));
    }
      ...
      <>
        ...
        isConnecting === false ? (
          ...
          >
            ...
            {isConnected && transferStatus.status !== '' && (
              <section
                className={`mb-6 mt-4 cursor-pointer shadow-lg outline-none border gap-2 [border:none] py-3 px-10 self-stretch rounded overflow-hidden flex flex-row items-center justify-center bg-infoFill text-lg text-text-2-d
                ${
      ...
      <>
        {newTransaction && (
          <div className="block mt-6">
            <Suspense
              fallback={
                <div className="text-gray-200/20">Loading component...</div>
              }
            >
