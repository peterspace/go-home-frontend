...
const SwapCrypto = (props) => {
  ...
  //   'transactionData',
  //   JSON.stringify(blockchainTransactionData)
  // ); // just for backup
...
*/
  ...
  async function getClientsTransacts() {
    ...
    // localStorage.setItem('tx', JSON.stringify(items[latestTransactionIndex]));
    // localStorage.setItem(
    //   'txId',
    //   JSON.stringify(items[latestTransactionIndex]?.txId)
    // );
