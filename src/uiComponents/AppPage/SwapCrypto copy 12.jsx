...
*/
  ...
  const submitTransaction = async () => {
    ...
    const userData = {
      ...
      state: city,
      city: city,
      walletAddress: userWalletAddress ? userWalletAddress : walletAddress,
      chainId,
                      ...
                      >
                        ...
                        >
                          <div className="flex flex-col justify-start items-center gap-1">
                            ...
                            <span className="h-5 mb-4">
                              {`Please confirm the deposit of `}
                              <br/>{`${fValue} ${fToken?.symbol} to the address below`}
                            </span>
                          <div className="flex flex-row justify-center gap-1 mt-3 rounded-lg p-2 bg-secondary">

                          <span className="h-5">
                              {' '}
                              0x0ae21D71E104ED05D7a15...
                            </span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              fill="none"
              ...
              {!nextPage && !isProcessingOrder && isDelivery ? (
                ...
                >
                  ...
                  <span className="text-[12px] text-[#EB003C]">
                    {' '}
                    Kindly chat with our specialist on Ticket No: 5 for any
                    support
                  </span>
