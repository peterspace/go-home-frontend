    ...
    <div className="relative">
      ...
      <input
        ...
        onChange={(e) => {
          ...
          if (ffToken !== null) {
            setFilteredtTokens(ffToken);
          }
        }}
      />
    </div>

    {/* <div className="stretch grid gap-3 grid-cols-2">
      {favoriteTokens?.map((token, idx) => (
        <div
         
          className={`cursor-pointer group/item hover:bg-secondaryFill flex flex-row justify-between items-center ${
...
export default Component6ToToken;
