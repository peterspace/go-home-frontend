// import { dTokenList } from '../assets';
import { dTokenList } from '../../assets';

const DTokenList = ({ setIsTokenModalVisible }) => {
  return (
    ...
    <div className="relative w-[1680px] h-[986px] overflow-hidden max-w-full max-h-full text-left text-lg text-text-1-d font-text-16-md">
      <img className="absolute w-[1680px] h-[986px]" alt="" src={dTokenList} />
      ...
      <div className="absolute top-[0px] left-[0px] bg-gray-200 [backdrop-filter:blur(80px)] w-[1680px] h-[934px] overflow-hidden text-base">
        ...
        <div className="absolute top-[162px] left-[600px] rounded-13xl bg-surface-1-64-d shadow-[0px_0px_16px_rgba(0,_0,_0,_0.04),_0px_24px_48px_-12px_rgba(16,_24,_40,_0.08)] box-border w-[480px] flex flex-col p-6 items-start justify-start gap-[24px] border-[1px] border-solid border-surface-tint-16-d">
          <div className="self-stretch flex flex-row items-center justify-center gap-[24px] text-xl">
          ...
          <div className="self-stretch flex flex-row items-start justify-start gap-[8px]">
            <div className="rounded-xl overflow-hidden flex flex-row py-2 pr-4 pl-2 items-center justify-start gap-[8px] border-[2px] border-solid border-surface-tint-d-8">
              <img
                className="relative w-6 h-6 shrink-0"
                alt=""
                src="/protocol-icon12.svg"
