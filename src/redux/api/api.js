...
const orderConfirmation = async (userData) => {
  try {
    const response = await axios.post(
      `${BACKEND_URL}/api/contactus/orderConfirmation`,
      userData
    );
...
const orderCompleted = async (userData) => {
  try {
    const response = await axios.post(
      `${BACKEND_URL}/api/contactus/orderCompleted`,
      userData
    );
    if (response.statusText === 'OK') {
...
export const registerAdmin = async (userData) => {
  try {
    ...
    const response = await axios.post(
      `${BACKEND_URL}/api/user/registerAdmin`,
      userData,
      config
      // { withCredentials: true }
    );
...
export const createTransaction = async (userData) => {
  ...
  try {
    const response = await axios.post(
      `${BACKEND_URL}/api/transaction/createTransaction`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const getUserTransactions = async (userData) => {
  ...
  try {
    const response = await axios.patch(
      `${BACKEND_URL}/api/transaction/getUserTransactions`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const getOneUserTransaction = async (userData) => {
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getOneUserTransaction`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const getAllTransactionsByUser = async (userData) => {
  const config = {
    headers: {
      'Content-type': 'application/json',
      Authorization: `Bearer ${user.token}`,
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getAllTransactionsByUser`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const updateTransactionsAutomatically = async (userData) => {
  ...
  try {
    const response = await axios.patch(
      `${BACKEND_URL}/api/transaction/updateTransactionsAutomatically`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const getTransactionByTxId = async (txId) => {
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getTransactionByTxId/${txId}`,
      config
    );
    if (response.data?._id) {
...
export const updateTransactionById = async (userData) => {
  ...
  try {
    const response = await axios.patch(
      `${BACKEND_URL}/api/transaction/updateTransactionById`,
      userData,
      config
    );
    if (response.data?._id) {
...
export const createCountry = async (userData) => {
  const config = {
    headers: {
      'Content-type': 'application/json',
    },
...
export const getAllCountries = async () => {
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/place/getAllCountries`,
      config
    );
    if (response.data?._id) {
      // toast.success('update Successful...');
...
export const getAllStatesByCountry = async (userData) => {
  const config = {
    headers: {
      'Content-type': 'application/json',
    },
...
export const getUserInactiveTransactions = async () => {
  ...
  console.log({ myToken: user.token });
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getUserInactiveTransactions`,
      config
    );
    if (response.data) {
      toast.success('fetch Successful...');
...
export const getUserActiveTransactions = async () => {
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getUserActiveTransactions`,
      config
    );
    if (response.data) {
      toast.success('fetch Successful...');
...
export const getManagerActiveTransactions = async () => {
  const config = {
    headers: {
      'Content-type': 'application/json',
      Authorization: `Bearer ${user.token}`,
  ...
  try {
    const response = await axios.get(
      `${BACKEND_URL}/api/transaction/getManagerActiveTransactions`,
      config
    );
    if (response.data) {
      toast.success('manager fetch Successful...');
      return response.data;
    }
  } catch (error) {
    const message =
...
export const createMessage = async (userData) => {
  try {
    const response = await axios.post(`${BACKEND_URL}/api/contactus`, userData);
    if (response.data) {
...
export const contactAutoReply = async (userData) => {
  try {
    const response = await axios.post(
      `${BACKEND_URL}/api/contactus/autoreply`,
      userData
    );
    // if (response.statusText === 'OK') {
    //   toast.success('registration confirmation');
