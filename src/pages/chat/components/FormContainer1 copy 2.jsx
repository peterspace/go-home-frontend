      ...
      <div className={styles.inboxContainerWrapper}>
        <div className={styles.inboxContainer}>
          ...
          {/* {isGroupChat ? (
            <div className={styles.inboxUsers}>
              <>
                {groupSearchResult?.map((user, idx) => (
                  <div key={idx} onClick={() => createTIcketChat(user)}>
          ...
          {/* {isGroupChat ? (
            <div className={styles.inboxUsers}>
              <>
                {groupSearchResult?.map(({ user, txId }) => (
                  <div key={txId} onClick={() => createTIcketChat(user, txId)}>
                    <div className="cursor-pointer transition-transform duration-300 hover:scale-110">
                      <AddNewGroupMember
                        user={user}
                        addNewGroupMemberPosition="unset"
          ...
          {isHome ? <div className={styles.inboxUsers}>{''}</div> : null}
        </div>
      </div>
