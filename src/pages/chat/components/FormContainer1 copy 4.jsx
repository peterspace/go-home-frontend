...
const FormContainer1 = (props) => {
  ...
  console.log({ newExchangeData: newExchangeData });
      ...
      <div className={styles.inboxInner}>
        <div className={styles.groupChatsParent}>
          ...
          {user?.isAdmin === true ? (
            ...
            <div
              className={`cursor-pointer ${styles.groupChats}`}
              // onClick={fetchUserInactiveTransactions}
              onClick={() => {
                fetchUserInactiveTransactions();
                setIsSearch(false);
                setIsAllChats(false);
        ...
        <div className={styles.inboxContainer}>
          {isHome ? (
            <div className={styles.inboxUsers}>
              {newExchangeData?.map((t, idx) => (
                <div
                  key={idx}
                  onClick={() => {
                    setSelectedExchangeData(t);
                    localStorage.setItem('transactionData', JSON.stringify(t));
