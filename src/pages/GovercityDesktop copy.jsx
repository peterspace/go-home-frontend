...
const GovercityDesktop = (props) => {
  ...
  return (
    <div className={`font-satoshi ${styles.govercityDesktop}`}>
      <div className={styles.goDesktopHome2}>
        ...
        <div className={styles.goDesktopHome2Inner}>
          <div className={styles.advertParent}>
            <div className={styles.advert}>
              <div className={styles.onboardDiverseAudiences}>
                Onboard diverse audiences worldwide with our great coverage and
                currencies offered
              </div>
              <div className={styles.globalCoverage}>Global coverage</div>
            </div>
            <div className={styles.supportedCountriesParent}>
            ...
            <div className={styles.frameParent}>
              <img
                ...
                alt=""
                // src="/frame-13213147315@2x.png"
                src="/coverage-350.png"
              />
              <div className={styles.supportedCountries}>
                Supported crypto Countries
              </div>
              <div className={styles.div1}>350+</div>
            </div>
            <div className={styles.supportedFiatCurrenciesParent}>
              <div className={styles.supportedCountries}>
              ...
              <img
                ...
                alt=""
                // src="/frame-13213147316@2x.png"
                src="/coverage-40.png"
              />
              <div className={styles.div2}>40+</div>
            </div>
            <div className={styles.majorPaymentMethodsParent}>
              <div className={styles.supportedCountries}>
        ...
        <div className={styles.sectionHeaderParent}>
          ...
          <div className={styles.servicesCard}>
            ...
            />
            <div className={styles.liquidityAggregationFrom}>
            Exchange your crypto assets on different chains simultaneously on our cross-chain platform
            </div>
        ...
        <div className={styles.payOptions}>
          ...
          <img className={styles.unionPay1Icon} alt="" src="/unionpay-1.svg" />
          ...
          <img className={styles.applePay1Icon} alt="" src="/applepay-1.svg" />
        ...
        <div className={styles.advertWrapper}>
          <div className={styles.advert2}>
            <div className={styles.liquidityAggregationFrom4}>
              Liquidity aggregation from multiple DEXes to ensure the best swap
              rates.
            </div>
            <div className={styles.services2}>Earn</div>
            <div className={styles.learnMoreParent}>
              <div className={styles.launch}>Learn More</div>
              <img
                className={styles.chevronRightIcon}
                alt=""
                src="/chevronright.svg"
        ...
        <img
          className={styles.goDesktopHome2Child}
          alt=""
          src="/frame-351@2x.png"
        />
      </div>
